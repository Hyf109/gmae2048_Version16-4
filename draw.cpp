...
void Game::draw_label(const char * font, const int& size, SDL_Color color,
const char * text, int x, int y, SDL_Renderer* renderer ){
...
void Game::paint_tile(int& i, int& j, const char * text, int font_size,
                      SDL_Color color_bg, SDL_Color color){
